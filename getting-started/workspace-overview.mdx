---
title: "First Launch & Layout Overview"
description: "Orient yourself: Top Bar, Canvas, Chat, Properties"
---
...
> tip: A simple first build — Create a Flow with: Input → Action (returns a message) → Output. Execute it with a small JSON payload to verify your end‑to‑end loop.