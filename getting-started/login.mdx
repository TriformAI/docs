...
description: "Sign in with Discord or GitHub and session basics"
---

## Sign in

1. Go to **app.triform.ai**.
2. Choose **Magic Link, Discord** or **GitHub**.
...
> note: Multiple Organizations — You can belong to multiple Organizations. Switch via Profile → Organization.
