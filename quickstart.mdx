...
!!! tip "Fastest first success"
    Start with a Flow: *Build me a news gatherer that collects news from 15 different Swedish sources and summarizes them*. Use the Execute panel to run a small JSON payload.
