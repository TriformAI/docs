---
title: "Welcome"
description: "Triform overview and two‑minute quickstart"
---
...
!!! tip "Fastest first success" Start with a Flow: _Build me a news gatherer that collects news from 15 different Swedish sources and summarizes them_. Use the Execute panel to run a small JSON payload.
