---
title: "Triggers"
description: "Entry points: API and Schedules; best practices"
---
...
> tip: Design for observability — Include correlation IDs or request metadata in your inputs for traceability across downstream Nodes.
