...
description: "Shared catalog: what lives there, why, and reuse"
---
...
> note: Project vs. Library — Project‑scoped Variables live under Properties → Global Variables. Library Variables are organizational and reused across Projects.
