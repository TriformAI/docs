---
title: "Modules"
description: "Importable utilities: use cases, guidelines, and refactoring"
---
...
> tip: Refactor to Modules — If you copy a helper between Actions twice, it’s time to promote it into a Module.
