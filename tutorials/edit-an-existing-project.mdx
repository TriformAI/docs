...
4. Configure SMTP settings in Global Variables
...
1. Create Global Variable for API key
...
**Solution:** Check environment differences, verify Global Variables are set, review logs

## Next steps

- [Edit a Specific Component](/tutorials/edit-a-specific-component)
- [Integrate Project into Your App](/tutorials/integrate-project-into-your-app)
- [Understanding Deployments](/concepts/deployments)
- [Debugging Best Practices](/triton/debugging)
