...
description: "Anatomy of a Flow and how to work inside it"
---
...
> tip: Start minimal — Begin with a single Action between Input and Output. Add parallel branches or conditions after the basic path works.
