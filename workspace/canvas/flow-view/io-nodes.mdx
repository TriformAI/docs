---
title: "Flow View: Input & Output Nodes"
description: "Add and use ports, typing, and best practices"
---
...
## Good practices
- Keep names singular and typed conceptually (e.g., `messages`).
- Add only the ports you need—prune unused ones to reduce confusion.

> note: Where types and defaults live — Configure types and default values for inputs/outputs in Properties → Input & Output.
