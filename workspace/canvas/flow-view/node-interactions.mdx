---
title: "Flow View: Node Interactions"
description: "Move, inspect, open, and use the context menu"
---
...
> tip: Declutter early — As a Flow grows, periodically rearrange Nodes to preserve left‑to‑right data flow and reduce cognitive load.
