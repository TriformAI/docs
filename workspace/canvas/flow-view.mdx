...
1. Select the Flow node in Project view
2. Go to Properties → Executions
3. Click an execution to see its trace
4. The Canvas highlights which path was taken
5. Node colors indicate: success (green), failure (red), skipped (gray)
...
**Method 3: Drag from Toolbox**
1. Open Agent Toolbox panel
