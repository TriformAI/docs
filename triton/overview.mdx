...
Triton lives in the **Chat Panel** at the bottom of the **Builder workspace**. Click the chat icon or press `Cmd+K` (Mac) / `Ctrl+K` (Windows) to open it.

> note: Triton is for **building** your systems. To **use** your agents conversationally, switch to the **Chat workspace** from the Top Bar.
