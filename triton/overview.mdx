...
- **Explain concepts** — _"How do Global Variables work?"_
...
- [Defining with Triton](/triton/defining) — Structure Projects conversationally
- [Building with Triton](/triton/building) — Create components step-by-step
- [Editing with Triton](/triton/editing) — Modify existing work
- [Debugging with Triton](/triton/debugging) — Troubleshoot issues
