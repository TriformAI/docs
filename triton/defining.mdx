...
- Global Variables needed: `STRIPE_API_KEY`, `SENDGRID_API_KEY`
...
Once you've defined your Project:

1. [Build it with Triton](/triton/building)
2. [Edit and refine components](/triton/editing)
